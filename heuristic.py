...
class HeurTreeNode(GameTree.TreeNode):
    ...
    def heuristic(self):
        return (self.p1points - self.p2points) + (1200 - self.gameNum) * 0.01 # Fromula, kura dod koeficentu. (Vel būs uzalbota)
